#!/bin/sh
ls -al /home/ubuntu/.ivy2/.nexus.rsci.co.credentials /root/.nexus.rsci.co.credentials
ln -sf /home/ubuntu/.ivy2/.nexus.rsci.co.credentials /root/.nexus.rsci.co.credentials
ls -al /home/ubuntu/.ivy2/.nexus.rsci.co.credentials /root/.nexus.rsci.co.credentials
...
ls -l /app/logs
for i in $(find /app/logs/ -name "*.log" -type f); do cat $i ; done
